    ...
    */
    ...
    static preload(scene) {
        if (scene instanceof Phaser.Scene) {
            scene.load.image("images.light-saber", "./assets/images/weapon/melees/light-saber/light-saber.png");
            scene.load.spritesheet("spritesheet.light-saber-effect", "./assets/images/weapon/melees/light-saber/light-saber-effect.png", { frameWidth: 38, frameHeight: 38 });
        }
    }
}